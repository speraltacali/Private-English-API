...
namespace PE.Infrastructure.Context.Migrations
{
    ...
    [Migration("20210423003028_03-relacionesUser")]
    partial class _03relacionesUser
    {
            ...
            modelBuilder.Entity("PE.Domain.Entity.Alumno.Alumno", b =>
                {
                    ...
                    b.HasOne("PE.Domain.Entity.Usuario.Usuario", "Usuario")
                        .WithMany()
            ...
            modelBuilder.Entity("PE.Domain.Entity.Usuario.Usuario", b =>
                {
                    ...
                    b.HasOne("PE.Domain.Entity.Persona.Persona", null)
                        .WithMany("Usuarios")
                        .HasForeignKey("PersonaId");
                });
